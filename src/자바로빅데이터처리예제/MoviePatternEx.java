...
//		준비단계
		...
		//영화 장르 초기화
		String[] feel = {"액션","모험","어드벤처","스릴러","멜로","코미디","공포",
						"드라마","판타지","경이","다큐","애니메이션","SF","뮤지컬"};
		
		int[] result = new int[feel.length];  //14개의 정수값을 담을 공간 마련 => 자동 0으로 초기화된다.
...
//		출력단계(if else를 간결하게 하는 방법 => continue 사용)
